...
TestResultInfo testResultInfo2 = new TestResultInfo(Terminology.PATHOLOGY_TEST_RESULT_INFO, "20190101", "", "", "검사명", "검사결과값", "참고치");
//영상검사결과 - testList와 testCode는 비워둠
TestResultInfo testResultInfo3 = new TestResultInfo(Terminology.IMAGE_TEST_RESULT_INFO, "20190101", "", "", "검사명", "검사결과값", "참고치");
//기능검사결과 - testList와 testCode는 비워둠
TestResultInfo testResultInfo4 = new TestResultInfo(Terminology.FUNCTION_TEST_RESULT_INFO, "20190101", "", "", "검사명", "검사결과값", "참고치");
//수술내역
...
//흡연상태
SmokeInfo smokeInfo = new SmokeInfo("흡연상태코드명칭", "흡연상태코드");
//음주상태
